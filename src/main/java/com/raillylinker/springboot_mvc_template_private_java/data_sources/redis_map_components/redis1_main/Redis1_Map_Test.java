...
public class Redis1_Map_Test extends BasicRedisMap<Redis1_Map_Test.ValueVo> {
    ...
    private static final @NotNull String MAP_NAME = "Redis1_Map_Test";
    ...
    public static class ValueVo {
        public ValueVo(
                ...
                // Object 변수 타입 사용 예시
                @NotNull InnerVo innerVo,
                // Object List 변수 타입 사용 예시
                @NotNull List<InnerVo> innerVoList
        ) {
        ...
        public @NotNull InnerVo innerVo;
        public @NotNull List<InnerVo> innerVoList;

        public record InnerVo(
                @NotNull String testString,
                @NotNull Boolean testBoolean
        ) {
        }
    }
}